...
export const MoneyInputDetect = (value: number | string) =>
  `${value}`.match(moneyReg)?.[0] || "";

export const convertCurrencyInputToString = (value: string) =>
  value.replace(/[^0-9.-]+/g, "");
...
export const getStringWithinLength = (
  value = "",
  allowedLength = 50,
  wordLength = 0
) => {
